...
if(!$validUsername || strlen($username) == 0){
	$_SESSION['errormsg'] = $_SESSION['errormsg'] . "Username taken.";
	header("Location: https://arcane-brook-41995.herokuapp.com/sc_login.php");
	exit;
}

if(!$validEmail){
	$_SESSION['errormsg'] = $_SESSION['errormsg'] . "Invalid email.";
	header("Location: https://arcane-brook-41995.herokuapp.com/sc_login.php");
	exit;
}
...
if(!$uppercase || !$lowercase || !$number || strlen($password) < 8){
	$_SESSION['errormsg'] = $_SESSION['errormsg'] . "Password must be 8 characters long, and contain an uppercase, lowercase, and numeric character.";
	header("Location: https://arcane-brook-41995.herokuapp.com/sc_login.php");
	exit;
}
