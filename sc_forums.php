			...
			<div>
				<?php
					...
					foreach($posts as $post){
						echo "<div class=\"forum\"><div id=\"title\">" . htmlspecialchars($post['title']) . "</div><div id=\"stamp\">". htmlspecialchars($post['username']) . "&nbsp". htmlspecialchars($post['created_at']) ."</div><div id=\"post\">" . htmlspecialchars($post['post']) . "</div></div>";		
